...
echo form_input(array('type' => 'hidden', 'name' => 'txtKd', 'value' => $kd_user_type));
?>
<div class="form-group">
	<label for="idSelParent" class="col-sm-2 control-label">Parent Type</label>
	<div class="col-sm-4 col-xs-4">
		<?php echo form_dropdown('selParent', $user_type_opts, $kd_parent, array('id' => 'idSelParent', 'class' => 'form-control')); ?>
	</div>
</div>
<div class="form-group">
	...
	<div class="col-sm-4 col-xs-4">
		...
		<?php echo form_input(array('name' => 'txtNm', 'id' => 'idTxtNm', 'class' => 'form-control', 'placeholder' => 'Nama Type', 'value' => $nm_user_type)); ?>
	</div>
</div>
<hr>
<div class="form-group">
