...
$master_var = 'DataBagian';
$form_id = 'idForm'.$master_var;
echo form_open_multipart('', array('id' => $form_id, 'class' => 'form-horizontal'));
echo form_input(array('type' => 'hidden', 'name' => 'txtKd', 'value' => $kd_bagian));
?>
...
<div class="form-group">
	<label for="idTxtNm" class="col-sm-2 control-label">Nama Bagian</label>
	<div class="col-sm-4 col-xs-4">
		<div id="idErrNm"></div>
		<?php echo form_input(array('name' => 'txtNm', 'id' => 'idTxtNm', 'class' => 'form-control', 'value' => $nm_bagian, 'placeholder' => 'Nama Bagian')); ?>
	</div>
</div>
<hr>
<div class="form-group">
