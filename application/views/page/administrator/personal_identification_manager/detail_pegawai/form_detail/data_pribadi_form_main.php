...
$tgl_lahir = empty($detail_row->tgl_lahir)?'':format_date($detail_row->tgl_lahir, 'd-m-Y');
$tgl_aktif = empty($detail_row->tgl_aktif)?'':format_date($detail_row->tgl_aktif, 'd-m-Y');
...
<div class="row" style="margin-top: 15px;">
	<div class="form-group col-sm-6 col-xs-12">
		...
		<div>
			<div id="idErrNm"></div>
			<?php echo form_input(array('name' => 'txtNm', 'id' => 'idTxtNm', 'class' => 'form-control', 'value' => $detail_row->nm_karyawan, 'placeholder' => 'Nama Karyawan', 'autofocus' => 'autofocus')); ?>
		</div>
	</div>
	<div class="form-group col-sm-6 col-xs-12">
		...
		<div>
			<div id="idErrNik"></div>
			<?php echo form_input(['name' => 'txtNik', 'id' => 'idNik', 'class' => 'form-control', 'placeholder' => 'NIK Karyawan', 'value' => $detail_row->nik_karyawan, 'readonly' => 'readonly']); ?>
		</div>
	</div>
</div>
<div class="row">
...
<div class="row">
	<div class="form-group col-sm-6 col-xs-12">
		...
		<div>
			...
			<?php echo form_input(array('name' => 'txtNoKtp', 'id' => 'idTxtNoKtp', 'class' => 'form-control', 'value' => $detail_row->no_ktp, 'placeholder' => 'No KTP')); ?>
		</div>
	</div>
	<div class="form-group col-sm-6 col-xs-12">
		...
		<div>
			...
			<?php echo form_dropdown('selJekel', ['' => '-- Pilih Jekel', 'laki' => 'Laki-Laki', 'perempuan' => 'Perempuan'], $detail_row->jekel, ['id' => 'idJekel', 'class' => 'form-control']); ?>
		</div>
	</div>
</div>
<div class="row">
