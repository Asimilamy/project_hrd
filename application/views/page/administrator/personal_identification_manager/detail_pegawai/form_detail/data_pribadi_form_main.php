...
echo form_input(array('type' => 'hidden', 'name' => 'txtKd', 'value' => $_SESSION['user']['kd_karyawan']));
?>
...
<div class="form-group col-sm-6 col-xs-12">
	...
	<div>
		...
		<?php echo form_input(array('name' => 'txtTmpLahir', 'id' => 'idTxtTmpLahir', 'class' => 'form-control', 'value' => $tmp_lahir, 'placeholder' => 'Tempat Lahir')); ?>
	</div>
</div>
<div class="form-group col-sm-6 col-xs-12">
	...
	<div>
		...
		<?php echo form_input(array('name' => 'txtTglLahir', 'id' => 'idTxtTglLahir', 'class' => 'form-control', 'value' => $tgl_lahir, 'placeholder' => 'Tanggal Lahir')); ?>
	</div>
</div>
<div class="form-group col-sm-12 col-xs-12">
	...
	<div>
		...
		<?php echo form_textarea(array('name' => 'txtAlamat', 'id' => 'idTxtAlamat', 'class' => 'form-control', 'rows' => '5', 'value' => $alamat, 'placeholder' => 'Alamat')); ?>
	</div>
</div>
<div class="form-group col-sm-6 col-xs-12">
	...
	<div>
		...
		<?php echo form_input(array('name' => 'txtTelpUtama', 'id' => 'idTxtTelpUtama', 'class' => 'form-control', 'value' => $no_telp_utama, 'placeholder' => 'Telp Utama')); ?>
	</div>
</div>
<div class="form-group col-sm-6 col-xs-12">
	...
	<div>
		...
		<?php echo form_input(array('name' => 'txtTelpLain', 'id' => 'idTxtTelpLain', 'class' => 'form-control', 'value' => $no_telp_lain, 'placeholder' => 'Telp Lain')); ?>
	</div>
</div>
<div class="form-group col-sm-6 col-xs-12">
	...
	<div>
		...
		<?php echo form_input(array('name' => 'txtEmailUtama', 'id' => 'idTxtEmailUtama', 'class' => 'form-control', 'value' => $email_utama, 'placeholder' => 'Email Utama')); ?>
	</div>
</div>
<div class="form-group col-sm-6 col-xs-12">
	...
	<div>
		...
		<?php echo form_input(array('name' => 'txtEmailLain', 'id' => 'idTxtEmailLain', 'class' => 'form-control', 'value' => $email_lain, 'placeholder' => 'Email Lain')); ?>
	</div>
</div>
<hr>
