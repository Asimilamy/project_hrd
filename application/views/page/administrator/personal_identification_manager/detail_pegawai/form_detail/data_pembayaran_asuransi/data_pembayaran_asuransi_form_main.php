...
<script type="text/javascript">
	...
	$(document).off('click', '.btn-add-asuransi-pembayaran').on('click', '.btn-add-asuransi-pembayaran', function() {
		open_detail_page({'file_type' : 'form', 'page_name': '<?php echo $page_name; ?>', 'kd_karyawan_asuransi_pembayaran' : ''});
	});

	$(document).off('click', '.btn-back-asuransi').on('click', '.btn-back-asuransi', function() {
		open_detail_page({'file_type' : 'table', 'page_name': 'data_asuransi'});
	});
