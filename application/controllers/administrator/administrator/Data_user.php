...
class Data_user extends MY_Controller {
	...
	*/
	...
	public function get_form() {
		...
		$data['data']['id'] = $id;
		$user_row = $this->tm_user->get_data($id);
		$data['data']['kd_master_type'] = $user_row['master_type_kd'];
		$data['data']['content_type'] = 'administrator';
	...
	public function open_form() {
		...
		$data['master_type_opts'] = $this->m_master_type->get_opts(array('type' => 'administrator'));
